...
public class PillagerHideoutPiece extends BaseStructurePiece{
    ...
    protected PillagerHideoutPiece(Either<ResourceLocation, StructureTemplate> template, Holder<StructureProcessorList> processors, StructureTemplatePool.Projection projection) {
